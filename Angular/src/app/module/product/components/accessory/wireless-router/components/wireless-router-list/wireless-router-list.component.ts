...
@Component({
  selector: 'wireless-router-list',
  templateUrl: './wireless-router-list.component.html',
  styleUrls: ['./wireless-router-list.component.css']
})
export class WirelessRouterListComponent implements OnInit {
  ...
  constructor(private wirelessRouterService: WirelessRouterService, private brandService: BrandService) { }
