...
@Component({
  selector: 'app-rice-cooker-list',
  templateUrl: './rice-cooker-list.component.html',
  styleUrls: ['./rice-cooker-list.component.css']
})
export class RiceCookerListComponent implements OnInit {
  ...
  constructor(private riceCookerService: RiceCookerService, private brandService: BrandService) { }
